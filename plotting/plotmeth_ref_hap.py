...
def main(args):
    ...
    #l1_box = matplotlib.patches.Rectangle((0,-0.5), elt_end-elt_start, 1.0, lw=1, edgecolor='k', facecolor='none')
    #ax.add_patch(l1_box)
    ...
    for phase in phase_order:
        windowed_methfrac, meth_n = slide_window(meth_table, phase, width=int(args.slidingwindowsize), slide=int(args.slidingwindowstep))
...
if __name__ == '__main__':
    ...
    parser.add_argument('-g', '--gtf', required=True, help='genes or intervals to display in gtf format')
    ...
    parser.add_argument('-s', '--slidingwindowsize', default=20, help='size of sliding window for smoothed plot (default=20)')
    parser.add_argument('-t', '--slidingwindowstep', default=2, help='size of sliding window for smoothed plot (default=2)')
    ...
    parser.add_argument('--ignore_tags', action='store_true', default=False)
